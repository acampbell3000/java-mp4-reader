...
/**
 * Class to encapsulate the MP4 file type box (skip).
 * 
 * @author Anthony Campbell - anthonycampbell.co.uk
 */
public class SkipBox extends AbstractBox implements UnusedBox {
	 ...
	 */
	public SkipBox(final MP4Reader reader, final long remainingOffset, final String boxName,
