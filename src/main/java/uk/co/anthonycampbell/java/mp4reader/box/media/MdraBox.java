...
/**
 * Class to encapsulate the MP4 media reference data type box (mdra).
 * 
 * @author Anthony Campbell - anthonycampbell.co.uk
 */
public class MdraBox extends AbstractBox implements Box {
	 ...
	 */
	public MdraBox(final MP4Reader reader, final long remainingOffset, final String boxName,
