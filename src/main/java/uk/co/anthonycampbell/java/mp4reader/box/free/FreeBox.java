...
/**
 * Class to encapsulate the MP4 file type box (free).
 * 
 * @author Anthony Campbell - anthonycampbell.co.uk
 */
public class FreeBox extends AbstractBox implements UnusedBox {
	 ...
	 */
	public FreeBox(final MP4Reader reader, final long remainingOffset, final String boxName,
