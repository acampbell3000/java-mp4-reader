package uk.co.anthonycampbell.java.mp4reader.box.free;
...
/**
 * Class to encapsulate the number of unknown bytes found inside a MP4 file.
 * 
 * @author Anthony Campbell - anthonycampbell.co.uk
 */
public class UnknownBox extends AbstractBox implements UnusedBox {
	 ...
	 */
	public UnknownBox(final MP4Reader reader, final long remainingOffset, final String boxName,
