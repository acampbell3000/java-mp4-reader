...
/**
 * Class to encapsulate the MP4 file type box (wide).
 * 
 * @author Anthony Campbell - anthonycampbell.co.uk
 */
public class WideBox extends AbstractBox implements UnusedBox {
	 ...
	 * @param boxType - box type ENUM.s
	 * @throws IOException Unable read remaining bytes from the stream.
	 */
	public WideBox(final MP4Reader reader, final long remainingOffset, final String boxName,
